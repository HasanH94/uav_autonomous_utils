...
class CombinedSearchAndPIDNode:
    def __init__(self):
        ...
        self.stop_distance = rospy.get_param("~stop_distance", 1.5)      # 1.5m
    ...
    def search_mode_step(self):
        ...
        If 30 seconds pass -> we give up (or just stop rotating).
        ...
        if elapsed > self.search_timeout:
            ...
            # You could land, or hold, or do something else. We'll just stop rotating for now.
            twist = Twist()
    ...
    def pid_mode_step(self):
        ...
        If within stop_distance, zero out velocity
    ...
    def switch_to_search(self):
        ...
        # Possibly stop the drone briefly
        twist = Twist()
        self.cmd_pub.publish(twist)
        rospy.sleep(0.5)
