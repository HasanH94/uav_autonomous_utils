    ...
    def callback_function(self, image_msg):
        ...
        if marker_IDs is not None and len(marker_IDs) > 0:
            ...
            for i in range(len(marker_IDs)):
                ...
                k_y = 0.05
                k_z = 0.05
                k_yaw = 0.02  # Gain for yaw control (tune based on your system)
                ...
                desired_yaw = 0  # Desired yaw (aligned with marker)
                yaw_error = desired_yaw - yaw_marker

                # Apply proportional control to the yaw rate
                self.pose.twist.angular.z = k_yaw * yaw_error
