...
class LoiterAndSignalNode:
    def __init__(self):
        rospy.init_node("loiter_and_signal_node", anonymous=True)
        ...
        rospy.loginfo("LoiterAndSignalNode initialized.")
    ...
    def set_loiter_mode(self):
        ...
        while not rospy.is_shutdown() and self.current_state.mode != "AUTO.LOITER":
            ...
            # Use rospy.sleep to prevent a busy-wait loop
            rospy.sleep(0.1)
